...
export default function CreateTaskModal({ isOpen, onClose, defaultProjectId, onSuccess }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-xl bg-[var(--tf-modal-bg)] border border-[var(--tf-border)] rounded-xl shadow-2xl overflow-hidden z-10">
        <div className="p-4 border-b border-[var(--tf-border)] bg-[var(--tf-sidebar)] flex items-center justify-between">
          <div className="flex items-center gap-2 text-[var(--tf-text-main)] font-bold text-base">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 bg-[var(--tf-input-bg)] border border-[var(--tf-border)] rounded-lg text-xs text-[var(--tf-text-main)] focus:outline-none focus:border-amber-500"
            >
              {projects.map((p) => (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full px-2.5 py-2 bg-[var(--tf-input-bg)] border border-[var(--tf-border)] rounded-lg text-xs text-[var(--tf-text-main)] focus:outline-none focus:border-amber-500"
              >
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-2 py-1.5 bg-[var(--tf-input-bg)] border border-[var(--tf-border)] rounded-lg text-xs text-[var(--tf-text-main)] focus:outline-none focus:border-amber-500"
              />
            </div>
          </div>
